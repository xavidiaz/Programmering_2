...
/**
 * Skriv ett proggram som läser in en textil som innehålller ett javaprogram
 * (alltsp en fil vars namn sultar på .java). Använd en diallogruta för att fråga
 * efter filens namn. Programment skall undersöka vilka rader i filen som innehåller
 * kommenrtarer. För enkelhets skull får du föutsätta att det i javaprogrammet
 * i filen bara finns kommentarer av typen //. Ditt program skall det visa resultatet
 * i en dialogruta. Där skall det stå hur många procent av raderna i fillen som
 * innehåller kommentarer.
 */
public class tio_01 {
    static String rubrik = "Beräkning av kommentarer procent.";
    public static void main(String[] arg) throws IOException {
        // läser in ett javaprogramfil i dialogruta.
